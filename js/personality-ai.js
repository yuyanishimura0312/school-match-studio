...
レポート構成（合計2500-3500字程度・ベンチマーク準拠の書籍体裁）:

<div class="bm-report"> でラップしてください。

セクション構成:
1. <h3>1. お子さんの人格と${school.school_name}の校風 — 基本相性</h3>
   400-500字で、お子さんのarchetype（${archName}）とこの学校の校風（建学の精神・教育設計）の相性を、保護者向けの優しいトーンで論じる。

2. <h3>2. 本校で発達する可能性のある能力</h3>
   400-500字で、Big Five値とこの校風が掛け合わさることで伸びそうな能力次元を具体的に。

3. <h3>3. ストレッチフィット的な発達課題</h3>
   400-500字で、この校風が課す発達的チャレンジ。「合わない」ではなく「成長機会」として記述。

4. <h3>4. 想定される活躍経路の幅</h3>
   400-500字で、複数の可能性を確率的に示す（断定回避）。

5. <h3>5. 歴史上の類型代表者との関連（時代翻訳付き）</h3>
   300-400字で、${eminentList}のような代表者を引きつつ、現代/未来への翻訳の必要性を明示。

6. <h3>6. ご家庭への問いかけ — この子と本校の組み合わせをどう考えるか</h3>
   300字程度で、判断軸となる問いを3-5個提示。
...
- Noto Serif JP想定の地の文中心、ですます調

引用がある場合は <blockquote>本文<span class="who">— 出典</span></blockquote> 形式。

HTMLで返してください（<div class="bm-report"> でラップ、h3/p/blockquote のみ使用、styleなし）。`;
